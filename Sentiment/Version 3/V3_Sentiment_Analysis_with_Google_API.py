...
def getSentimentForAPerson(text_list):
	...
	for persons_comment in text_list:
		...
		a_comment = str(persons_comment).encode('utf-8')
		doc = types.Document(
			content=a_comment,
...
if False:
	print(analyizeAllThePeopleAndDumpToJSON("twitter_Comments_by_Leaders.json", file_out ="v2twitter_Comments_by_Leaders.json"))
